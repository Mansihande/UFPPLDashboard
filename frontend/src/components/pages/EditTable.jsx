...
import img from '../images/vite.svg'
import {
...
const Example = () => {
  ...
  const handleImageUpload = (event, row) => {
    ...
    reader.onload = () => {
      ...
      const index = newData.findIndex((user) => user.id === row.original.id);
      newData[index] = { ...newData[index], image: reader.result };
